...
(function(b){b.fn.scrollParent=function(){var a=/(auto|scroll)/,c=this.css("position"),d=this.parents().filter(function(){var d=b(this);if("absolute"===c&&"static"===d.css("position"))return!1;var e=d.css(["overflow","overflowX","overflowY"]);return a.test(e.overflow+e.overflowX+e.overflowY)}).eq(0);return"fixed"!==c&&d.length?d:b((this[0].ownerDocument||document).documentElement)}})(jQuery);
